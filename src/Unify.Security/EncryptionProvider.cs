...
public class EncryptionProvider(IEncryptionKeyProvider encryptionKeyProvider) : IEncryptionProvider
{
  ...
  private string EncryptStringCommon(
    string? data,
    byte[]? dataBytes,
  ...
  private byte[] EncryptBytesCommon(
    string? data,
    byte[]? dataBytes,
    string? associatedData,
    byte[]? associatedDataBytes
  ...
  {
    string encryptedData = EncryptStringCommon(
      data,
      dataBytes,
      associatedData,
      associatedDataBytes
  ...
  private string DecryptStringCommon(
    string? data,
    byte[]? dataBytes,
    string? associatedData,
    byte[]? associatedDataBytes
  ...
  private byte[] DecryptBytesCommon(
    string? data,
    byte[]? dataBytes,
    string? associatedData,
    byte[]? associatedDataBytes
  ...
  {
    string decryptedData = DecryptStringCommon(
      data,
      dataBytes,
      associatedData,
      associatedDataBytes
  ...
  public string EncryptString(string data, string? associatedData) =>
    EncryptStringCommon(data, null, associatedData, null);

  public string EncryptString(string data, byte[]? associatedData) =>
    EncryptStringCommon(data, null, null, associatedData);

  public string EncryptString(byte[] data, string? associatedData) =>
    EncryptStringCommon(null, data, associatedData, null);

  public string EncryptString(byte[] data, byte[]? associatedData) =>
    EncryptStringCommon(null, data, null, associatedData);
  ...
  public string DecryptString(string data, string? associatedData) =>
    DecryptStringCommon(data, null, associatedData, null);

  public string DecryptString(string data, byte[]? associatedData) =>
    DecryptStringCommon(data, null, null, associatedData);

  public string DecryptString(byte[] data, string? associatedData) =>
    DecryptStringCommon(null, data, associatedData, null);

  public string DecryptString(byte[] data, byte[]? associatedData) =>
    DecryptStringCommon(null, data, null, associatedData);
  #endregion
  ...
  public byte[] EncryptBytes(string data, string? associatedData) =>
    EncryptBytesCommon(data, null, associatedData, null);

  public byte[] EncryptBytes(string data, byte[]? associatedData) =>
    EncryptBytesCommon(data, null, null, associatedData);

  public byte[] EncryptBytes(byte[] data, string? associatedData) =>
    EncryptBytesCommon(null, data, associatedData, null);

  public byte[] EncryptBytes(byte[] data, byte[]? associatedData) =>
    EncryptBytesCommon(null, data, null, associatedData);
  ...
  public byte[] DecryptBytes(string data, string? associatedData) =>
    DecryptBytesCommon(data, null, associatedData, null);

  public byte[] DecryptBytes(string data, byte[]? associatedData) =>
    DecryptBytesCommon(data, null, null, associatedData);

  public byte[] DecryptBytes(byte[] data, string? associatedData) =>
    DecryptBytesCommon(null, data, associatedData, null);

  public byte[] DecryptBytes(byte[] data, byte[]? associatedData) =>
    DecryptBytesCommon(null, data, null, associatedData);
  #endregion
}
