...
public class AmsiException : Exception
{
  ...
  public static AmsiException AmsiNotFound =>
    new AmsiException($"Amsi ({Amsi.AmsiDllName}) was not found on this machine");
  ...
  public static AmsiException AmsiInvalidState =>
    new AmsiException(
      "Amsi is in invalid state to perform operation. Check configuration of available Amsi providers"
    );
