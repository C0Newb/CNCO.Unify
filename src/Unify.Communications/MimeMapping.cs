namespace CNCO.Unify.Communications {
    ...
    /// </summary>
    /// <remarks>
    /// Modeled after FileExtensionContentTypeProvider: https://github.com/dotnet/aspnetcore/blob/fa239f20a52defa06029f6a316846d6e190e05bb/src/Middleware/StaticFiles/src/FileExtensionContentTypeProvider.cs
    /// </remarks>
    public class MimeMapping {
        private static MimeMapping? _primaryInstance;
        ...
        /// </summary>
        public MimeMapping() : this(new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
            {
                { ".323", "text/h323" },
                { ".3g2", "video/3gpp2" },
                { ".3gp2", "video/3gpp2" },
        ...
        public MimeMapping(IDictionary<string, string> mapping) => Mappings = mapping ?? throw new ArgumentNullException(nameof(mapping));
        ...
        /// <returns>True if MIME type could be determined</returns>
        public static bool TryGetMimeType(string filePath, out string? mimeType) {
            string extension = GetFileExtension(filePath);
            if (extension == null) {
                mimeType = null;
                return false;
            }
            _primaryInstance ??= new MimeMapping();
            return _primaryInstance.Mappings.TryGetValue(extension, out mimeType);
        }

        /// <summary>
        /// Given a file path, determines the file extension.
        /// </summary>
        /// <param name="path">Path to the file.</param>
        /// <returns>The last segment of text behind the last period.</returns>
        ...
        /// </summary>
        /// <param name="path">Path to the file.</param>
        /// <returns>All segments of text in front the last period.</returns>
