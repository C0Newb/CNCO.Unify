...
public static class SinkLoggerExtensions
{
  ...
  public static SinkLogger UseConsoleLogger(this SinkLogger logger) =>
    UseConsoleLogger(logger, new ConsoleLogger());

  public static SinkLogger UseConsoleLogger(this SinkLogger logger, string section) =>
    UseConsoleLogger(logger, new ConsoleLogger(section));

  public static SinkLogger UseConsoleLogger(this SinkLogger logger, ILogFormatter formatter) =>
    UseConsoleLogger(logger, new ConsoleLogger(formatter));

  public static SinkLogger UseConsoleLogger(this SinkLogger logger, ConsoleLogger diagnosticsLogger)
  {
  ...
  public static SinkLogger UseDiagnosticsLogger(this SinkLogger logger) =>
    UseDiagnosticsLogger(logger, new DiagnosticsLogger());

  public static SinkLogger UseDiagnosticsLogger(this SinkLogger logger, string section) =>
    UseDiagnosticsLogger(logger, new DiagnosticsLogger(section));

  public static SinkLogger UseDiagnosticsLogger(this SinkLogger logger, ILogFormatter formatter) =>
  ...
  public static SinkLogger UsingFileLogger(this SinkLogger logger, FileLogger fileLogger)
  {
