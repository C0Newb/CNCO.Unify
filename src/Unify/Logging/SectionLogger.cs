namespace CNCO.Unify.Logging {
    ...
    /// </summary>
    public sealed class SectionLogger : Logger {
        private readonly ILogger _parent;
        private readonly string _proxyName;
        private readonly bool _appendSectionName;

        /// <summary>
        /// Creates a new instance of <see cref="SectionLogger"/> given a section name.
        ...
        public SectionLogger(ILogger parent, string sectionName, bool appendSectionName = true) {
            _parent = parent;
